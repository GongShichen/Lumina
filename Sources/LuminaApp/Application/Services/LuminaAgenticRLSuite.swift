...
enum LuminaAgenticRLSuite {
    ...
    private static let templates: [Template] = [
        ...
        Template(instruction: "帮我创建一个 LuminaTest 晚间复盘流程：今晚 21:30 创建提醒，提醒内容包括回顾支出、整理待办、查看明早日程。", category: "reminder_planning", difficulty: "medium", tools: ["device.current_time", "calendar.search", "reminder.create"]),
